...
def stop_process(process):
    """Stop a child process without leaving it running or unreaped."""
...
def main():
    ...
    # Stereo interleaved float32: L R L R ...
    bytes_per_chunk = chunk * 2 * 4
    ...
    while True:
        ...
        while True:
            ...
            payload_values = (*sl, *sr, *al, *ar, ul, ur, aul, aur)
            line = " ".join(f"{value:.3f}" for value in payload_values)
            with _state_lock:
                _state["payload"] = line
